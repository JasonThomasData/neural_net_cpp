...
public:
    ...
    void output_layer_set_synapse_weight(std::shared_ptr<ISynapse>& synapse, double neuron_error);
    ...
    void hidden_layer_set_synapse_weight(std::shared_ptr<ISynapse>& synapse, double logistic_derivative, double total_neuron_error);
    double hidden_layer_get_total_neuron_errors(std::vector<std::shared_ptr<ISynapse>>& outgoing_synapse);
