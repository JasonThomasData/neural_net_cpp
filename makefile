all: synapse.o soma.o neuron.o neural_net.o neural_net integration.o tests clean
...
neural_net:
	g++ $(CXXFLAGS) build/synapse.o build/soma.o build/neuron.o build/neural_net.o -o bin/neural_net


integration.o:
	g++ -c $(CXXFLAGS) test/integration.cpp -o build/integration.o
tests:
	g++ $(CXXFLAGS) build/integration.o build/soma.o build/synapse.o build/neuron.o -o bin/tests/integration
