all: synapse.o soma.o input.o neuron.o network.o main.o classifier.o main i_t_synapse.o i_t_soma.o i_t_neuron.o i_t_network.o  i_t_main.o integration clean
...
integration:
	g++ $(CXXFLAGS) build/i_t_synapse.o build/i_t_soma.o build/i_t_neuron.o build/i_t_network.o build/i_t_main.o build/soma.o build/synapse.o build/input.o build/neuron.o build/network.o build/classifier.o -o bin/tests/integration
